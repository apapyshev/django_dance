...
def index(request):
    zodiacs = list(list_zodiak.keys())
    li_zodiac = ''
    for _ in zodiacs:
        redirect_path = reverse("horoscope-name", args=(_, ))
